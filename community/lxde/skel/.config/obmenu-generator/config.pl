...
our $CONFIG = {
  ...
  icon_dirs_first 			=> ['/usr/share/icons/Faenza-Green'],
  icon_dirs_last 			=> ['/usr/share/icons/gnome'],
  icon_dirs_second 			=> ['/usr/share/icons/Faenza'],
  missing_icon              => "gtk-missing-image",
  skip_app_command_re       => "xfce4-about",
  skip_app_name_re          => "PNMixer",
  skip_file_content_re      => "exo-open",
  skip_file_name_re         => "gksu.desktop",
  skip_svg_icons            => 1,
  terminal                  => "lxterminal",
  use_only_my_icon_dirs     => 0,
  VERSION                   => 0.54,
  wine_desktop_files_paths  => ["/home/manjaro/.local/share/applications/wine"],
